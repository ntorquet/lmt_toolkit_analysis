...
from lmtanalysis import BuildEventTrain2, BuildEventFollowZone, BuildEventRear5, BuildEventSocialApproach, \
    BuildEventSocialEscape, BuildEventApproachContact, BuildEventOralOralContact, \
    BuildEventApproachRear, BuildEventGroup2, BuildEventOralGenitalContact, \
    BuildEventStop, BuildEventMove, BuildEventSideBySide, BuildEventSideBySideOpposite, BuildEventDetection, \
